...
colorMoradoIntenso = "#ab9df2"
colorAmarilloIntenso = "#ffd866"

# Color de Barra  
colorBarra = colores["base"]

# Colores de los Widgets de la Barra.  
colorMenuRofi = colores["blue"]
colorIndicadorDeActualizaciones = colores["red"]
colorVolumen = colores["sky"]
colorBrillo = colores["yellow"]
colorBateria = colores["green"]
colorFechaYHora = colores["mauve"]

# Colores del Textos en la Barra del sistema.
